...
public class ICG {
    ...
    public StringBuilder TransExp(Node exp, StringBuilder place) {
        if (exp.NodeName.equals("VNAME")) {
            VariableProps vp = symbolTable.table.get(exp.id);
            return new StringBuilder(vp.translatedName);
        }
    ...
    public StringBuilder TransBranch(Node branch) {
        ...
        return code1.append("LABEL ").append(label1).append(code2).append("GOTO ").append(label3).append("LABEL ")
                .append(label2).append(code3).append("LABEL ").append(label3);
    }
    ...
    public StringBuilder transCond(Node cond, StringBuilder labelt, StringBuilder labelf){
        return new StringBuilder();
    }
